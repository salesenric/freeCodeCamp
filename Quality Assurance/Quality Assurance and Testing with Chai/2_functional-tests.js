  ...
  suite('Integration tests with chai-http', function () {
    ...
    test('Test GET /hello with your name', function (done) {
      chai
        .request(server)
        .keepOpen()
        .get('/hello?name=h3nry')
        .end(function (err, res) {
          assert.equal(res.status, 200, 'Response status should be 200');
          assert.equal(res.text, 'hello h3nry', 'Response should be "hello h3nry"');
          done();
        });
    });
    // #3
...
Browser.site = 'https://3000-freecodecam-boilerplate-3bbl6uipuf6.ws-eu116.gitpod.io'; // Your URL here
