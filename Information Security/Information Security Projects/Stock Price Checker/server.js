...
// Content Security Policy - allow loading of scripts and CSS only from your server
app.use(helmet.contentSecurityPolicy({
  directives: {
    ...
    connectSrc: ["'self'"],   // Allow connections to your own domain
    imgSrc: ["'self'"],       // Allow images from your own domain
